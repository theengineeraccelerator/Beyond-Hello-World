...
<libraries>
<library name="bi-rotencoder">
<description>&lt;b&gt;BI EN12-HS11 series rotary encoder (w/ switch) &lt;/b&gt;</description>
<packages>
<package name="ROTENC_EN12_HS">
<wire x1="-6.2" y1="6.6" x2="6.2" y2="6.6" width="0.127" layer="21"/>
<wire x1="6.2" y1="6.6" x2="6.2" y2="-6.6" width="0.127" layer="21"/>
<wire x1="6.2" y1="-6.6" x2="-6.2" y2="-6.6" width="0.127" layer="21"/>
<wire x1="-6.2" y1="-6.6" x2="-6.2" y2="6.6" width="0.127" layer="21"/>
<circle x="0" y="-0.1" radius="3.1" width="0.127" layer="21"/>
...
<pin name="D" x="-12.7" y="-5.08" length="short" direction="pwr"/>
<pin name="A" x="12.7" y="5.08" length="short" direction="in" rot="R180"/>
<pin name="E" x="-12.7" y="5.08" length="short" direction="pas"/>
<pin name="C" x="12.7" y="-5.08" length="short" direction="pwr" rot="R180"/>
</symbol>
</symbols>
<devicesets>
<deviceset name="ROTENC_EN12_HS" prefix="ROT" uservalue="yes">
<gates>
<gate name="G$1" symbol="ROTENC" x="0" y="0"/>
</gates>
<devices>
<device name="ROTENC_EN12_HS" package="ROTENC_EN12_HS">
<connects>
...
<gates>
<gate name="G$1" symbol="CON05" x="-2.54" y="0"/>
</gates>
<devices>
...
<parts>
<part name="ROT1" library="bi-rotencoder" deviceset="ROTENC_EN12_HS" device="ROTENC_EN12_HS"/>
<part name="JP1" library="1-Generic" deviceset="M05" device="PTH"/>
</parts>
<sheets>
<sheet>
<plain>
...
<instances>
<instance part="ROT1" gate="G$1" x="27.94" y="58.42"/>
...
<pinref part="ROT1" gate="G$1" pin="E"/>
...
<pinref part="ROT1" gate="G$1" pin="D"/>
...
<wire x1="7.62" y1="73.66" x2="55.88" y2="73.66" width="0.1524" layer="91"/>
